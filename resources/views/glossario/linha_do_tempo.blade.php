            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p class="direito paragrafo">
                        Paulo Reglus Neves Freire nasceu em 19 de setembro de 1921 no Recife, capital do estado  brasileiro de Pernambuco. </br><a href="#">leia mais</a>
                    </p>
                </div>
        ...
        <div id="conteudo2">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p class="paragrafo">
                        Sua família fazia parte da classe média, mas Paulo Freire vivenciou a pobreza e a fome na infância durante a depressão de 1929, uma experiência que o levaria a se preocupar com os mais pobres e o ajudaria a construir seu revolucionário método de alfabetização. </br><a href="#">leia mais</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div id="conteudo3">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p class="direito paragrafo">
                        Paulo Freire ingressa na Faculdade de Direito do Recife. Naquela época, o curso de direito era a única alternativa na área de ciências humanas. Nesse período, conheceu a professora primária Elza Maia Costa Oliveira... </br><a href="#">leia mais</a>
                    </p>
                </div>
                <div class="col-md-2 coluna_vermelha texto_italico_central">
                    <div class="row justify-content-center ano_acizentado_negrito">
        ...
        <div id="conteudo5">
            <div class="row">
                <div class="col-md-4"> 
                    ...
                    <p class="direito paragrafo">
                        Paulo Freire assume o cargo de Diretor do Departamento de Educação e Cultura do Serviço Social, onde travou contato com a questão da educação de adultos/trabalhadores e percebeu a necessidade de executar um trabalho direcionado à alfabetização. </br><a href="#">leia mais</a>
                    </p>
                </div>
                <div class="col-md-2 coluna_vermelha texto_italico_central">
                    <div class="row justify-content-center ano_acizentado_negrito">
        ...
        <div id="conteudo6">
            <div class="row">
                ...
                <div class="col-md-6"> 
                    ...
                    <p class="paragrafo">
                        Em 1961 tornou-se diretor do Departamento de Extensões Culturais da Universidade do Recife e, no mesmo ano, realizou junto com sua equipe as primeiras experiências de alfabetização popular que levariam à constituição do Método Paulo Freire. </br><a href="#">leia mais</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div id="conteudo7">
            <div class="row">
                <div class="col-md-4"> 
                    ...
                    <p class="direito paragrafo">
                        Seu equipe foi responsável pela alfabetização de 300 cortadores de cana em apenas 45 dias. </br><a href="#">leia mais</a>
                    </p>
                </div>
                <div class="col-md-2 coluna_vermelha texto_italico_central">
                    <div class="row justify-content-center ano_acizentado_negrito">
        ...
        <div id="conteudo8">
            <div class="row">
                ...
                <div class="col-md-6"> 
                    ...
                    <p class="paragrafo">
                        Em 1964, meses depois de iniciada a implantação do Plano, o golpe militar extinguiu esse esforço. Freire foi encarcerado como traidor por 70 dias. </br><a href="#">leia mais</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div id="conteudo9">
            <div class="row">
                <div class="col-md-4"> 
                    ...
                    <p class="direito paragrafo">
                        Durante o exílio, Paulo Freire passou pela Bolívia e trabalhou no Chile por cinco anos para o Movimento de Reforma Agrária da Democracia Cristã e para a Organização das Nações Unidas para a Agricultura e a Alimentação. </br><a href="#">leia mais</a>
                    </p>
                </div>
                <div class="col-md-2 coluna_vermelha texto_italico_central">
                    <div class="row justify-content-center ano_acizentado_negrito">
        ...
        <div id="conteudo10">
            <div class="row">
                ...
                <div class="col-md-6"> 
                    ...
                    <p class="paragrafo">
                        No ano anterior, ele havia concluído a redação de seu mais famoso livro, Pedagogia do Oprimido, que foi publicado em várias línguas como o espanhol, o inglês (em 1970) e até o hebraico (em 1981). </br><a href="#">leia mais</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div id="conteudo11">
            <div class="row">
                <div class="col-md-4"> 
                    ...
                    <p class="direito paragrafo">
                        Freire foi convidado para ser professor visitante da Universidade Harvard em 1969. Nesse período, conheceu a professora primária Elza Maia Costa Oliveira... </br><a href="#">leia mais</a>
                    </p>
                </div>
                <div class="col-md-2 coluna_vermelha texto_italico_central">
                    <div class="row justify-content-center ano_acizentado_negrito">
        ...
        <div id="conteudo12">
            <div class="row">
                ...
                <div class="col-md-6"> 
                    ...
                    <p class="paragrafo">
                        Com a Anistia em 1979 Freire pôde retornar ao Brasil, mas só o fez em 1980. </br><a href="#">leia mais</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div id="conteudo13">
            <div class="row">
                <div class="col-md-4"> 
                    ...
                    <p class="direito paragrafo">
                        Integrou o Partido dos Trabalhadores, tendo sido Presidente da 1ª Diretoria Executiva da Fundação Wilson Pinheiro, fundação de apoio partidária instituída pelo PT em 1981 (antecessora da Fundação Perseu Abramo). </br><a href="#">leia mais</a>
                    </p>
                </div>
                <div class="col-md-2 coluna_vermelha texto_italico_central">
                    <div class="row justify-content-center ano_acizentado_negrito">
        ...
        <div id="conteudo14">
            <div class="row">
                ...
                <div class="col-md-6"> 
                    ...
                    <p class="paragrafo">
                        Freire foi nomeado secretário de Educação da cidade de São Paulo. Exerceu esse cargo de 1989 a 1991. </br><a href="#">leia mais</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div id="conteudo16">
            <div class="row">
                ...
                <div class="col-md-6"> 
                    ...
                    <p class="paragrafo">
                        Freire morreu de um ataque cardíaco em 2 de maio de 1997, às 6h53, no Hospital Albert Einstein, em São Paulo. </br><a href="#">leia mais</a>
                    </p>
                </div>
            </div>
        </div>
